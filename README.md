...
- Normalized the data into 3-table relational Star Schema: `dim_fighters`, `fact_fights`, and `fighter_stats` (Seen from `01_CreateTables.sql`) 
...
- Created a Trigger that catches data integrity and sends it to an audit log (Seen from `04_Audit_Log.sql`)
